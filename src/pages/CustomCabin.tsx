...
const CustomCabin = () => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      let basePrice = area * 15000000; // Base price per sqm
      ...
      specs.extras.forEach((extra) => {
        if (extra === "solar") basePrice += 25000000;
        if (extra === "ac") basePrice += 15000000;
        if (extra === "deck") basePrice += 20000000;
        if (extra === "storage") basePrice += 10000000;
      });
  ...
  const handleAddToCart = () => {
    const customProduct = {
      ...
      description: `Custom designed cabin with ${specs.bedrooms}BR${
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  { id: "solar", label: "Solar Power System", price: "+25M" },
                  { id: "ac", label: "Air Conditioning", price: "+15M" },
                  { id: "deck", label: "Outdoor Deck", price: "+20M" },
                  { id: "storage", label: "Extra Storage", price: "+10M" },
                ].map((extra) => (
                  <label
                    key={extra.id}
